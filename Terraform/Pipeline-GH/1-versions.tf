...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-AKSCluster-aakki"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "backendterraakkiamine"      # mettre le nom du compte de stockage créer dans le lab 1
